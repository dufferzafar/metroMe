    ...
    <div class="page secondary with-sidebar">
		...
		<div class="page-region">
        	<div class="page-region-content" style="padding:50px 150px 20px 50px;">
            	<p>I've always believed the fact that scripting comes from a lazy soul, if you aren't lazy, you won't mind going through the trouble of renaming each and every file in a folder, just to change its extension (Duh!) when it could've been scripted easily. But this becomes fairly addictive once you get the hang of it. Once you realise the true potential of a language, what it can do for you, how it can really make your life easy, you just don't wanna let go of it.</p>
